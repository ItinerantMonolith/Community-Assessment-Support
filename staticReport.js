...
const REPORTS = [ 
    { name: 'Population by Geographic Area and Year', fields: [ { name: 'Population', code: 'B01003_001E', type: 'number' } ], isTrend: true },
    { name: 'Poverty Rate by Geographic Area and Year',  fields: [ { name: 'Percent Below Poverty Rate', code: 'B17001_002E,B17001_001E', type: 'percent'} ], isTrend: true },
